...
import numpy as np
from adjust_edges import  fetch_X_atoms_ind_array
...
def addxoo2edge(eG,sc_unit_cell):
    ...
    for n in EDGE_nodes:
        ...
        if len(V_nodes) == 0:
            ...
            print('no V node connected to this edge node, this linker is a isolated linker',n)
            continue
        all_Xs_vnodes_ind= []
